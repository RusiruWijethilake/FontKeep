...
class $SecureSettingsTable extends SecureSettings
    with TableInfo<$SecureSettingsTable, SecureSetting> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $SecureSettingsTable(this.attachedDatabase, [this._alias]);
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'secure_settings';
  @override
  VerificationContext validateIntegrity(
    Insertable<SecureSetting> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  @override
  SecureSetting map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  $SecureSettingsTable createAlias(String alias) {
    return $SecureSettingsTable(attachedDatabase, alias);
  }
}

class SecureSetting extends DataClass implements Insertable<SecureSetting> {
  final String key;
  final String value;
  const SecureSetting({required this.key, required this.value});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
  ...
  SecureSettingsCompanion toCompanion(bool nullToAbsent) {
    return SecureSettingsCompanion(key: Value(key), value: Value(value));
  }

  factory SecureSetting.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  SecureSetting copyWith({String? key, String? value}) =>
      SecureSetting(key: key ?? this.key, value: value ?? this.value);
  SecureSetting copyWithCompanion(SecureSettingsCompanion data) {
    return SecureSetting(
  ...
  @override
  String toString() {
    return (StringBuffer('SecureSetting(')
          ..write('key: $key, ')
          ..write('value: $value')
          ..write(')'))
        .toString();
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is SecureSetting &&
          other.key == this.key &&
          other.value == this.value);
}

class SecureSettingsCompanion extends UpdateCompanion<SecureSetting> {
  final Value<String> key;
  final Value<String> value;
  final Value<int> rowid;
  const SecureSettingsCompanion({
    this.key = const Value.absent(),
    this.value = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  SecureSettingsCompanion.insert({
    required String key,
    required String value,
    this.rowid = const Value.absent(),
  }) : key = Value(key),
       value = Value(value);
  static Insertable<SecureSetting> custom({
  ...
  SecureSettingsCompanion copyWith({
    Value<String>? key,
    Value<String>? value,
    Value<int>? rowid,
  }) {
    return SecureSettingsCompanion(
      key: key ?? this.key,
  ...
  @override
  String toString() {
    return (StringBuffer('SecureSettingsCompanion(')
          ..write('key: $key, ')
          ..write('value: $value, ')
          ..write('rowid: $rowid')
          ..write(')'))
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $SecureSettingsTable secureSettings = $SecureSettingsTable(this);
  @override
...
typedef $$SyncLogsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$SecureSettingsTableCreateCompanionBuilder =
    SecureSettingsCompanion Function({
      required String key,
      required String value,
      Value<int> rowid,
    });
typedef $$SecureSettingsTableUpdateCompanionBuilder =
    SecureSettingsCompanion Function({
      Value<String> key,
      Value<String> value,
      Value<int> rowid,
...
class $$SecureSettingsTableFilterComposer
    extends Composer<_$AppDatabase, $SecureSettingsTable> {
  $$SecureSettingsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$SecureSettingsTableOrderingComposer
    extends Composer<_$AppDatabase, $SecureSettingsTable> {
  $$SecureSettingsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$SecureSettingsTableAnnotationComposer
    extends Composer<_$AppDatabase, $SecureSettingsTable> {
  $$SecureSettingsTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$SecureSettingsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $SecureSettingsTable,
          ...
          $$SecureSettingsTableOrderingComposer,
          $$SecureSettingsTableAnnotationComposer,
          $$SecureSettingsTableCreateCompanionBuilder,
          $$SecureSettingsTableUpdateCompanionBuilder,
          (
            SecureSetting,
            BaseReferences<_$AppDatabase, $SecureSettingsTable, SecureSetting>,
          ),
          SecureSetting,
          PrefetchHooks Function()
        > {
  $$SecureSettingsTableTableManager(
    _$AppDatabase db,
    $SecureSettingsTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$SecureSettingsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$SecureSettingsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$SecureSettingsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                ...
                Value<int> rowid = const Value.absent(),
                  ...
                  SecureSettingsCompanion(key: key, value: value, rowid: rowid),
          createCompanionCallback:
              ({
                required String key,
                required String value,
...
typedef $$SecureSettingsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $SecureSettingsTable,
      SecureSetting,
...
class $AppDatabaseManager {
  ...
  $$SecureSettingsTableTableManager get secureSettings =>
      $$SecureSettingsTableTableManager(_db, _db.secureSettings);
}
